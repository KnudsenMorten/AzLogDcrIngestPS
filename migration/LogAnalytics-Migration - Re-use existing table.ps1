...
#region section v1
    ...
    #----------------------------------------------------------------------------
        ...
        $LogAnalyticsWorkspaceAccessKey = "xxx"
...
write-host "Wait until table has been created in LogAnalytics and data can be found"
pause
...
#############################################################################
    ...
    #-------------------------------------------------------------------------------------------
        ...
        $LogAnalyticsWorkspaceResourceId              = "/subscriptions/xxxxx/resourceGroups/rg-loganalyticsv2demo/providers/Microsoft.OperationalInsights/workspaces/log-loganalyticsv2-migration-demo" 
